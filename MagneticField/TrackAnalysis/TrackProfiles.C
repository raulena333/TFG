...
//=========  (Tue Apr 16 19:09:38 2024) by ROOT version 6.30/04
   TCanvas *fCanvas = new TCanvas("fCanvas", "",2020,132,1600,600);
...
// ------------>Primitives in pad: pad1_1
   ...
   pad1_1__1->Draw();
   pad1_1__1->cd();
   pad1_1__1->Range(-10625,-1437.5,10625,1437.5);
   ...
   Graph_Graph1->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph16->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph16->GetYaxis()->SetTitleSize(0.03);
   ...
   TLegendEntry *entry=leg->AddEntry("","Track 1","l");
...
// ------------>Primitives in pad: pad1_2
   ...
   pad1_2__2->Draw();
   pad1_2__2->cd();
   pad1_2__2->Range(-10625,-0.3125,10625,2.8125);
   ...
   Graph_Graph17->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph17->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph18->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph18->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph19->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph19->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph20->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph20->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph21->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph21->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph22->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph22->GetYaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph23->GetXaxis()->SetTitleSize(0.03);
   ...
   Graph_Graph23->GetYaxis()->SetTitleSize(0.03);
