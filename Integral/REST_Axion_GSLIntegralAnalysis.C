...
//*** - accuracyInitial: Initial integration length (default: 1.).
//*** - accuracyFinal: Final integration length (default: 0.01).
//***
//*** Dependencies:
...
Int_t REST_Axion_GSLIntegralAnalysis(Int_t nData = 200, Double_t Ea = 4.2, std::string gasName = "He", Double_t mi = 0.25, 
